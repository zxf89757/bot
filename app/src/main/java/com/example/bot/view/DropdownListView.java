...
public class DropdownListView extends ListView implements OnScrollListener {
	...
	private final static int REFRESHING = 2;  //下拉刷新
	private final static int DONE = 3;     //完成刷新
	private final static int LOADING = 4;  //正在刷新
	...
	private void init(Context context) {
		...
		FrameLayout fl = (FrameLayout) inflater.inflate(R.layout.dropdown_lv_head, null);
		...
		int headContentWidth = headView.getMeasuredWidth();
